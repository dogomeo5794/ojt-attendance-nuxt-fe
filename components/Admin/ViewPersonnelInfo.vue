    ...
    <div class="row">
      <div class="col-sm-4 col-md-3 col-lg-3">
        ...
        <div class="form-group mb-3">
          <span class="form-control" style="height: auto; text-align: justify">
            The Authorized personnel are the person who checks the attendance of
            OJTs on a daily basis
          </span>
        </div>
                    ...
                    <div class="col-lg-6">
                      ...
                      <span
                        ...
                        style="
                          ...
                          margin-left: 10px;
                        "
                        v-if="!search_loading && is_found_office === false"
                      >
                        <i class="fas fa-check-circle text-success"></i> Add as
                        new Office
                      </span>
                    </div>
                  </div>
